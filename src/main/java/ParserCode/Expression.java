...
//t
    ...
    /**
     * thrown for irrecoverable syntax errors and stack overflow. Nested for convenience, does not depend on parser
     * class.
     */
    ...
    /**
     * must be implemented by a scanner object to supply input to the parser. Nested for convenience, does not depend on
     * parser class.
     */
    public interface yyInput {
        ...
        /**
         * associated with current token. Should not be called if {@link #advance()} returned <tt>false</tt>.
         *
...
//t    this.yydebug = (jay.yydebug.yyDebug)yydebug;
    ...
    /**
     * initial size and increment of the state/value stack [default 256]. This is not final so that it can be
     * overwritten outside of invocations of {@link #yyparse}.
     */
    protected int yyMax;

    /**
     * executed at the beginning of a reduce action. Used as <tt>$$ = yyDefault($1)</tt>, prior to the user-specified
     * action, if any. Can be overwritten to provide deep copy, etc.
     *
