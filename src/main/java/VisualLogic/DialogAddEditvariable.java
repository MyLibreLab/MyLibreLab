...
public class DialogAddEditvariable extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] {"Double", "String", "Boolean", "Integer", "1D_Double", "1D_String", "1D_Boolean",
                        "1D_Integer", "2D_Double", "2D_String", "2D_Boolean", "2D_Integer", " "}));
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(layout.createSequentialGroup().addContainerGap()
                        ...
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(jTextField2)
                                .add(jTextField1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
                                .add(jComboBox1, 0, 160, Short.MAX_VALUE).add(jTextField3))
                        .add(40, 40, 40)
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        ...
        layout.setVerticalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(layout
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(jLabel2).add(jButton1)
    ...
    public static void executeEdit(java.awt.Frame parent, OpenVariable node) {
        DialogAddEditvariable frm = new DialogAddEditvariable(parent, true);
        frm.setTitle(
                java.util.ResourceBundle.getBundle("VisualLogic/DialogAddEditvariable").getString("EDIT VARIABLE"));
