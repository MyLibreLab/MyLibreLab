...
public class FrameDoc extends javax.swing.JDialog {
    ...
    public FrameDoc(java.awt.Frame parent) {
        ...
        jTabbedPane1.addTab(java.util.ResourceBundle.getBundle("VisualLogic/FrameDoc").getString("DOCUMENTATION"),
                panel);
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(jPanel2Layout.createSequentialGroup().add(jLabel1)
        ...
        jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
                jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(jLabel1).add(label)));
