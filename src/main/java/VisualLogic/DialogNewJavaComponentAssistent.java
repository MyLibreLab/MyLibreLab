        ...
        try {
            for (int i = 0; i < settings.properties.size(); i++) {
                ...
                if (item.name.length() > 0) {
                    ...
                    out.write("    element.jAddPEItem(\"" + item.name + "\", prop" + item.name + ", " + item.min + ", " + item.max + ");");
                    out.newLine();
                }
            }
        } catch (Exception ex) {
    ...
    public void generateCircuitJavaFile(String basisDestPath, String srcPath, int type) {
        try {
            ...
            if (settings.pins.size() == 4) {
                ...
                out.newLine();
                out.write("    initPinVisibility(" + pinsTopVisible + "," + pinsRightVisible + "," + pinsBottomVisible + "," + pinsLeftVisible + ");");
                out.newLine();
            } else {
