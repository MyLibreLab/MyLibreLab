...
public class LicenceAgreementDialog extends JDialog {
    ...
    private LicenceAgreementDialog(final Frame parent, final boolean modal) {
        super(parent, modal);
        initComponents();
    }
     ...
     */
    public static Result showLicenceDialog(final Frame parent) {
        return UIUtil.runAndWait(() -> showDialog(parent));
    }

    private static Result showDialog(final Frame parent) {
