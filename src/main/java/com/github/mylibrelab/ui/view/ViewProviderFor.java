 ...
 */
public interface ViewProviderFor<ModelType> extends ProviderFor<ModelType, JComponent> {

    @Override
    default JComponent provide(final ModelType target) {
     ...
     */
    JComponent createView(final ModelType model);
}
