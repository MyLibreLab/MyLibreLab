...
public class UIStyle {
    ...
    @NotNull
    public static <T extends JComponent> T withFontFamily(@NotNull final T component, @NotNull final String fontName) {
    ...
    @NotNull
    public static <T extends JComponent> T withTransformedFont(@NotNull final T component,
