...
public class UndoAction extends BasicAction {

    public UndoAction() {
        super(Resources.getResourceText("actions.undo.displayName"),
                AllIcons.Actions.Undo, AllIcons.Actions.UndoDisabled);
    }
