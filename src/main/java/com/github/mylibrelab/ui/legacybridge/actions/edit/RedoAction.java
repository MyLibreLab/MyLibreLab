...
@Action
@ParentGroup(groups = UndoRedoGroup.class)
public class RedoAction extends BasicAction {

    public RedoAction() {
        super(Resources.getResourceText("actions.redo.displayName"),
                AllIcons.Actions.Redo, AllIcons.Actions.RedoDisabled);
    }
