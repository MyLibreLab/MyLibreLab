...
public class DisableVMProtectionAction extends BasicAction {

    public DisableVMProtectionAction() {
        super(Resources.getResourceText("actions.disableVMProtection.displayName"));
    }
