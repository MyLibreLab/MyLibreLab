package com.github.mylibrelab.elements.front.tworobotics.robotarmthreed.one.zero;/*
...
public class Panel extends JVSMain implements PanelIF {
    ...
    public void processPanel(int pinIndex, double value, Object obj) {
        if (panelX != null) {
            ...
            } else if (pinIndex == 1 && obj instanceof VSDouble) {
                VSDouble tmp = (VSDouble) obj;

                panelX.setZ1Angle(tmp.getValue());
            } else if (pinIndex == 2 && obj instanceof VSDouble) {
                VSDouble tmp = (VSDouble) obj;

                panelX.setZ2Angle(tmp.getValue());
            } else if (pinIndex == 3 && obj instanceof VSDouble) {
                VSDouble tmp = (VSDouble) obj;

                panelX.setZ3Angle(tmp.getValue());
            } else if (pinIndex == 4 && obj instanceof VSDouble) {
                VSDouble tmp = (VSDouble) obj;

                panelX.setHandAngle(tmp.getValue());
            } else if (pinIndex == 5 && obj instanceof VSBoolean) {
         ...
         *
         * imgX= Toolkit.getDefaultToolkit().createImage(new
         * MemoryImageSource(vsimg.getWidth(),vsimg.getHeight(),vsimg.getPixels(), 0, vsimg.getWidth()) );
         *
         * }
