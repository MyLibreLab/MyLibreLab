...
package com.github.mylibrelab.elements.front.twodekoratoren.userdef.triangle.jv;/*
                                                                                 * Copyright (C) 2020 MyLibreLab
...
public class Triangle extends JVSMain {
    ...
    private VSInteger Quadrant = new VSInteger(3);
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            if (Quadrant.getValue() == 1) {
                p.addPoint(r.x + 2 + c * 2, r.y + c * 2);
                p.addPoint(r.x + r.width - 2 - 2 * c, r.y + r.height - 2 - 2 * c);
                p.addPoint(r.x + r.width - 2 - 2 * c, r.y + c * 2);
            }
            if (Quadrant.getValue() == 2) {
                p.addPoint(r.x + 2 + c * 2, r.y + c * 2);
                p.addPoint(r.x + r.width - 2 - 2 * c, r.y + c * 2);
                p.addPoint(r.x + 2 + c * 2, r.y + r.height - 2 - 2 * c);
            }
            if (Quadrant.getValue() == 3) {
                p.addPoint(r.x + 2 + c * 2, r.y + c * 2);
                p.addPoint(r.x + r.width - 2 - 2 * c, r.y + r.height - 2 - 2 * c);
                p.addPoint(r.x + 2 + c * 2, r.y + r.height - 2 - 2 * c);
            }
            if (Quadrant.getValue() == 4) {
                p.addPoint(r.x + r.width - 2 - 2 * c, r.y + c * 2);
                p.addPoint(r.x + r.width - 2 - 2 * c, r.y + r.height - 2 - 2 * c);
                p.addPoint(r.x + 2 + c * 2, r.y + r.height - 2 - 2 * c);
            }
    ...
    public void setPropertyEditor() {
        ...
        element.jAddPEItem("Fillen", fill, 0, 0);
        element.jAddPEItem("Quadrant (1-4)", Quadrant, 1, 4);
        localize();
    }
    ...
    private void localize() {
        ...
        element.jSetPEItemLocale(d + 4, language, "Quadrant (1-4)");
        ...
        element.jSetPEItemLocale(d + 4, language, "Cuadrante (1-4)");
    }
