...
package com.github.mylibrelab.elements.front.twoautomation.industrial.buttons.jv.button.eight.jv;/*
                                                                                                  * Copyright (C) 2020
                                                                                                  * MyLibreLab
                                                                                                  * Based on MyOpenLab
                                                                                                  * by Carmelo Salafia
...
public class TasterPanel extends JVSMain {
    ...
    private final VSBoolean vertical = new VSBoolean(true);
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            if (baseVisible.getValue()) {
                tWidth = (r.width) - strokeValue.getValue();
                tHeight = (r.height) - strokeValue.getValue();
                X0 = (strokeValue.getValue() / 2);
            ...
            if (vertical.getValue()) {
                ...
                if (down.getValue()) {
                    ...
                    g2.fillRect(X0 + 1, Y0, tWidth - 2, (tHeight / 3));
                    buttonDarkColor.setFillColor(g2);
                    g2.fillRect(X0 + 1, Y0 + (tHeight / 3), tWidth - 2, (2 * (tHeight / 3)) - 3);
                    g2.setColor(edgeColor.getValue());
                    g2.setStroke(strokeLine);
                    g2.drawRect(X0 + 1, Y0, tWidth - 2, (tHeight / 3));
                    g2.drawRect(X0 + 1, Y0 + (tHeight / 3), tWidth - 2, (2 * (tHeight / 3)) - 3);
                } else {
                    Y0 = (int) ((r.height * 0.5));
                    buttonDarkColor.setFillColor(g2);

                    g2.fillRect(X0 + 1, Y0, tWidth - 2, (2 * (tHeight / 3)) - 3);

                    buttonLigthColor.setFillColor(g2);
                    g2.fillRect(X0 + 1, Y0 + (2 * tHeight / 3) - 3, tWidth - 2, (tHeight / 3));

                    g2.setColor(edgeColor.getValue());
                    g2.setStroke(strokeLine);

                    g2.drawRect(X0 + 1, Y0, tWidth - 2, (2 * (tHeight / 3)) - 3);
                    g2.drawRect(X0 + 1, Y0 + (2 * tHeight / 3) - 3, tWidth - 2, (tHeight / 3));
                ...
                if (down.getValue()) {
                    X0 = (int) ((r.width * 0.5));
                    buttonLigthColor.setFillColor(g2);
                    g2.fillRect(X0 + 1, Y0 + 2, 2 * (tWidth / 3), (tHeight) - 3);
                    buttonDarkColor.setFillColor(g2);
                    g2.fillRect(X0 + 2 * (tWidth / 3), Y0 + 2, (tWidth / 3), tHeight - 3);
                    g2.setColor(edgeColor.getValue());
                    g2.setStroke(strokeLine);

                    g2.drawRect(X0 + 1, Y0 + 2, 2 * (tWidth / 3), (tHeight) - 3);
                    g2.drawRect(X0 + 2 * (tWidth / 3), Y0 + 2, (tWidth / 3), tHeight - 3);

                } else {
                    Y0 = (int) ((r.height * 0.5) - tHeight / 2);
                    X0 = (int) ((r.width * 0.5) - tWidth);
                    buttonLigthColor.setFillColor(g2);
                    g2.fillRect(X0 + 1, Y0 + 2, tWidth / 3, (tHeight) - 3);
                    buttonDarkColor.setFillColor(g2);
                    g2.fillRect(X0 + (tWidth / 3), Y0 + 2, 2 * (tWidth / 3), tHeight - 3);
                    g2.setColor(edgeColor.getValue());
                    g2.setStroke(strokeLine);
                    g2.drawRect(X0 + 1, Y0 + 2, tWidth / 3, (tHeight) - 3);
                    g2.drawRect(X0 + (tWidth / 3), Y0 + 2, 2 * (tWidth / 3), tHeight - 3);
                }
            ...
            if (textVisible.getValue()) {
                ...
                if (mouseOver)
                    g2.setColor(overfontColor.getValue());
                else
                    g2.setColor(fontColor.getValue());
                if (mouseOver)
                    g2.setFont(overfont.getValue());
                else
                ...
                if (vertical.getValue()) {
                    if (down.getValue()) {
                        ...
                        Y0 = (int) ((r.height * 0.37) + (rFont.getHeight()) / 4);
                    } else {
                        X0 = (int) ((r.width * 0.5) - (rFont.getWidth()) / 2);
                        Y0 = (int) ((r.height * 0.63) + (rFont.getHeight()) / 4);
                    }
                } else {
                    if (down.getValue()) {
                        X0 = (int) ((r.width * 0.64) - (rFont.getWidth()) / 2);
                        Y0 = (int) ((r.height * 0.5) + (rFont.getHeight()) / 4);
                    } else {
                        X0 = (int) ((r.width * 0.32) - (rFont.getWidth()) / 4);
                        Y0 = (int) ((r.height * 0.5) + (rFont.getHeight()) / 4);
                    }
                }
    ...
    public void mouseMoved(MouseEvent e) {
        ...
        if (e != null) {
            ...
            if (e.getPoint().x + 10 < (element.jGetBounds().x + element.jGetBounds().width - 10)
                    && e.getPoint().y + 10 < element.jGetBounds().y + element.jGetBounds().height - 10) {
                mouseOver = true;
            }
