...
package com.github.mylibrelab.elements.front.twoautomation.pipeline.jv.right.derivation.jv;/*
                                                                                            * Copyright (C) 2020
                                                                                            * MyLibreLab
...
public class LEDPanel extends JVSMain implements PanelIF {
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            tWidth = ((element.jGetWidth() - ((BorderSize + stroke.getValue()))) - stroke.getValue()) / 2;
