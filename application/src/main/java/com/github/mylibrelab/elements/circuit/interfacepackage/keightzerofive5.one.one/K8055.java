...
package com.github.mylibrelab.elements.circuit.interfacepackage.keightzerofive5.one.one;/*
                                                                                         * Copyright (C) 2020 MyLibreLab
...
public class K8055 extends JVSMain implements MyOpenLabDriverOwnerIF {
    ...
    private final VSInteger counterBouncingTime1 = new VSInteger(50);
    private final VSInteger counterBouncingTime2 = new VSInteger(50);
    ...
    private final VSInteger outCounter1 = new VSInteger(0);
    private final VSInteger outCounter2 = new VSInteger(0);
    ...
    public void getCommand(String commando, Object value) {
        ...
        if (value instanceof Boolean) {
            ...
            if (commando.equals("COUNTER1")) {
                outCounter1.setValue(val.intValue());
                element.notifyPin(7);
            } else if (commando.equals("COUNTER2")) {
                outCounter2.setValue(val.intValue());
                element.notifyPin(8);
            }
        }
    ...
    public void elementActionPerformed(ElementActionEvent evt) {
        ...
        switch (idx) {
            ...
            case 19:
                driver.sendCommand("RESET_COUNTER_1", null);
                break; // Reset Counter 1
            case 20:
                driver.sendCommand("RESET_COUNTER_2", null);
                break; // Reset Counter 2
        }
    }
