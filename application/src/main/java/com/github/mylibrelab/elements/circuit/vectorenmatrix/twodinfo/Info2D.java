...
package com.github.mylibrelab.elements.circuit.vectorenmatrix.twodinfo;/*
                                                                        * Copyright (C) 2020 MyLibreLab
...
public class Info2D extends JVSMain {
    private Image image;
    private VSObject in;
    private final VSInteger cols = new VSInteger(0);
    private final VSInteger rows = new VSInteger(0);
