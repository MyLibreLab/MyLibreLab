...
package com.github.mylibrelab.elements.circuit.analoge.elemente.generator;/*
                                                                           * Copyright (C) 2020 MyLibreLab
...
public class Generator extends JVSMain {
    ...
    private final VSInteger buffLen = new VSInteger(3000);
    private final VSDouble step = new VSDouble(0.1);
    private final VSDouble precision = new VSDouble(10.0);
    ...
    public void processor() {
        ...
        for (int i = 0; i < outX.getValue().length; i++) {
            ...
            switch (freqTyp.getValue()) {
                case 0:
                    y = Math.sin(x * zoomX.getValue());
                    break;
                case 1:
                    y = dreieck(x * zoomX.getValue());
                    break;
                case 2:
                    y = rechteck(x * zoomX.getValue());
                    break;
                case 3:
                    y = saegezahn(x * zoomX.getValue());
                    break;
            }
