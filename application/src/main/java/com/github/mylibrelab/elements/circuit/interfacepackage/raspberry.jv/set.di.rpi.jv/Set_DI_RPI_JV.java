...
package com.github.mylibrelab.elements.circuit.interfacepackage.raspberry.jv.set.di.rpi.jv;// ********************************
...
public class Set_DI_RPI_JV extends JVSMain {
    ...
    public void process() {
        ...
        if (Error_in.getValue() && Enable_VM_in.getValue()) { // if There are error do not execute code and out the
                                                              // error to handle in the Error Handler VM.
        ...
        if (Enable_VM_in.getValue() && firstTime == true && Error_in.getValue() == false) // Only executes one time if
                                                                                          // no error.
        {
            ...
            try {
                ...
                Process p =
                        Runtime.getRuntime().exec("gpio mode " + wPi_Pin_Number_in.getValue() + " " + Pull_Res_Mode);
                if (Debug_Window_En_in.getValue()) {
                    element.jConsolePrintln(Element_Tag + Debug_Tag + "|Executing:" + "gpio mode "
                            + wPi_Pin_Number_in.getValue() + " " + Pull_Res_Mode + "|");
                }
                ...
                if (Debug_Window_En_in.getValue()) {
                    element.jConsolePrintln(Element_Tag + Error_Tag + "|Command Error: gpio mode "
                            + wPi_Pin_Number_in.getValue() + " " + Pull_Res_Mode + "|");
                }
                Error_out.setValue(true);
