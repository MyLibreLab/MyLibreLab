...
package com.github.mylibrelab.elements.circuit.interfacepackage.serialcom.jv.read.serialport.jv;
// ********************************
            ...
            try {
                ...
                if (Debug_Window_En_in.getValue()) {
                    element.jConsolePrintln(
                            Element_Tag + "Proccessing Read Serial Port: " + SerialPortNameIn.getValue());
                }
