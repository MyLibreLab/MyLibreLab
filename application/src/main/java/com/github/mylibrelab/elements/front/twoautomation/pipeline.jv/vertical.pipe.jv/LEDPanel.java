package com.github.mylibrelab.elements.front.twoautomation.pipeline.jv.vertical.pipe.jv;/*
...
public class LEDPanel extends JVSMain implements PanelIF {
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            int WidthMax = element.jGetWidth();
            int HeightMax = element.jGetHeight();

            int BorderSize = cnxSize.getValue();
            int X0 = stroke.getValue() / 2;
            int Y0 = stroke.getValue() / 2;
            int tHeight = BorderSize + stroke.getValue();
            int tWidth = element.jGetWidth() - (stroke.getValue());
            ...
            Y0 += tHeight;
            X0 += element.jGetWidth() / 8;
            tHeight = (element.jGetHeight() - (2 * (BorderSize + stroke.getValue())) - stroke.getValue());
            ...
            tWidth = element.jGetWidth() - (stroke.getValue());
