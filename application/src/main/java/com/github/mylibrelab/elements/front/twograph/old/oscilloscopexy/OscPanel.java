...
public class OscPanel extends JVSMain implements PanelIF {
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            if (xAchseLettersBottom)
                xAchseColor = Color.black;
            else
                xAchseColor = Color.white;
            if (yAchseLettersLeft)
                yAchseColor = Color.black;
            else
                yAchseColor = Color.white;
            ...
            if (inX != null && inY != null) {
                drawGraph(g, x, y, mitteX, mitteY, inX, inY);
    ...
    public void openPropertyDialog() {
        ...
        if (FrameProperties.result == true) {
            ...
            FrameProperties.yAchseLeft = false;
            FrameProperties.xAchseBottom = false;
