...
package com.github.mylibrelab.elements.circuit.vectorenmatrix.stringmatrix;// *****************************************************************************
...
public class MatrixNXM extends JVSMain {
    ...
    private Image image;
    private final VS2DString matrix = new VS2DString(3, 3);
    ...
    public void init() {
        ...
        setName("Matrix String");

        element.jSetResizable(false);

        setSize(34 + 10, 36);
        element.jSetCaption("String Matrix");
    }
    ...
    public void initOutputPins() {
        VS2DString ref = new VS2DString(0, 0);
    ...
    public void setPropertyEditor() {
        element.jAddPEItem("Tabelle..", more, 0, 0);
        localize();
    }
    ...
    private void localize() {
        ...
        language = "en_US";
        element.jSetPEItemLocale(d, language, "Table...");
