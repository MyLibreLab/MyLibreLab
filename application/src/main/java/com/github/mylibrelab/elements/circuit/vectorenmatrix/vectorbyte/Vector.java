...
package com.github.mylibrelab.elements.circuit.vectorenmatrix.vectorbyte;// *****************************************************************************

import java.awt.Image;

import com.github.mylibrelab.elements.circuit.vectorenmatrix.vectorbyte.src.mytableeditor.MyTableEditor;
...
public class Vector extends JVSMain {
    ...
    private Image image;
    private final VS1DByte vector = new VS1DByte(3);
