...
package com.github.mylibrelab.elements.circuit.dekoratoren.xrectangle;// *****************************************************************************
...
public class XRectangle extends JVSMain {
    ...
    private final VSColor fillColor = new VSColor(Color.LIGHT_GRAY);
    private final VSColor strokeColor = new VSColor(Color.black);
