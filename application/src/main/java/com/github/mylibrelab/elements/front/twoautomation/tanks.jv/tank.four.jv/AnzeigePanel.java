...
package com.github.mylibrelab.elements.front.twoautomation.tanks.jv.tank.four.jv;/*
                                                                                  * Copyright (C) 2020 MyLibreLab
...
public class AnzeigePanel extends JVSMain implements PanelIF {
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            tHeight = (int) ((element.jGetHeight() * 0.7) + (strokeValue.getValue() / 2));
            X0 = (int) (element.jGetWidth() * 0.5) - (tWidth / 2);
            Y0 = (int) (((element.jGetHeight() * 0.25)) + strokeValue.getValue());
            ...
            tWidth = (int) (element.jGetWidth() * 0.75);
            tHeight = (int) (element.jGetHeight() * 0.60);
            X0 = (int) (element.jGetWidth() * 0.5) - (tWidth / 2);
            ...
            g2.fillArc(p1.x, Y0, tWidth, tHeight, 0, 180);
            ...
            g2.drawArc(p1.x, Y0, tWidth, tHeight, 0, 180);
