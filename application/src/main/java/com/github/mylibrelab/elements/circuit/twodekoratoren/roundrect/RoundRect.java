...
package com.github.mylibrelab.elements.circuit.twodekoratoren.roundrect;/*
                                                                         * Copyright (C) 2020 MyLibreLab
...
public class RoundRect extends JVSMain {
    ...
    private final VSInteger arcWidth = new VSInteger(20);
    private final VSInteger arcHeight = new VSInteger(20);
    private final VSInteger colorTransparency = new VSInteger(100);
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            {
                // g2.setColor(new
                // Color(fillColor.getValue().getRed(),fillColor.getValue().getGreen(),fillColor.getValue().getBlue(),colorTransparency.getValue()));

                fillColor.setFillColor(g2);
                g2.fillRoundRect(r.x + c, r.y + c, r.width - c * 2 - 1, r.height - c * 2 - 1, arcWidth.getValue(),
                        arcHeight.getValue());
            }
            ...
            if (strokeWidth.getValue() > 0) {
                ...
                g2.drawRoundRect(r.x + c, r.y + c, r.width - c * 2 - 1, r.height - c * 2 - 1, arcWidth.getValue(),
                        arcHeight.getValue());
            }
