...
package com.github.mylibrelab.elements.front.twonumerisch.tank.eight.jv;/*
                                                                         * Copyright (C) 2020 MyLibreLab
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            if (OverlayTresholds.getValue()) {
                ...
                if (value > LowValue.getValue() && value <= MediumValue.getValue())
                    OverlayTemp.setValue(MediumColor.getValue());
            ...
            if (overlay)
                g2.setColor(OverlayTemp.getValue());
            else
            ...
            GradientPaint gp = new GradientPaint(0f, 50f, fillColor1.getValue(), (float) element.jGetBounds().width,
                    50f, fillColor2.getValue());
