...
package com.github.mylibrelab.elements.front.version.two.zero.dekoratoren.image.two.zero;// *****************************************************************************
...
public class XImage extends JVSMain {
    private final VSImage image = new VSImage();
    private final VSBoolean interpoliert = new VSBoolean();
    private final VSBoolean keepAcpect = new VSBoolean();
    private final VSBoolean tiled = new VSBoolean(false);
    private final VSInteger tiledWidth = new VSInteger(100);
    private final VSInteger tiledHeight = new VSInteger(100);
