...
public class DialogPins extends javax.swing.JDialog {
    ...
    private final ArrayList<JPanel> pin_panels = new ArrayList();
            ...
            if (cols.length == 2) {
                ...
                for (JPanel panel : pin_panels) {
                    ...
                    if (pinNo.equals(pinNumber)) {
                        ...
                        active.setSelected(pinActive.equals("a"));
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogPins.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
