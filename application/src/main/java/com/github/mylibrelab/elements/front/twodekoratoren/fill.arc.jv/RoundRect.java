...
package com.github.mylibrelab.elements.front.twodekoratoren.fill.arc.jv;/*
                                                                         * Copyright (C) 2020 MyLibreLab
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            if (fill.getValue()) {
                ...
                g2.fillArc(r.x + c, r.y + c, r.width - c * 2 - 1, r.height - c * 2 - 1, startAngle.getValue(),
                        arcAngle.getValue());
            }
            ...
            if (strokeWidth.getValue() > 0) {
                ...
                g2.drawArc(r.x + c, r.y + c, r.width - c * 2 - 1, r.height - c * 2 - 1, startAngle.getValue(),
                        arcAngle.getValue());
