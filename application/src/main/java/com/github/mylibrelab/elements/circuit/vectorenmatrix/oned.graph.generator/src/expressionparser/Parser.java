...
package com.github.mylibrelab.elements.circuit.vectorenmatrix.oned.graph.generator.src.expressionparser;/*
                                                                                                         * Copyright (C)
                                                                                                         * 2020
                                                                                                         * MyLibreLab
                                                                                                         * Based on
    ...
    private double calc(ArrayList vector) {
        ...
        while (pointer < vector.size()) {
            ...
            if (token.isNum || token.isVar)
                ...
                if (token.op.equals("%"))
                    return num % calc(vector);
                else if (token.op.equals("^"))
                    return Math.pow(num, calc(vector));
                else if (token.op.equals("+"))
                    return num + calc(vector);
                else if (token.op.equals("-"))
                    return num - calc(vector);
                    ...
                    return num / calc(vector);
                else if (token.op.equals("*")) return num * calc(vector);
            } else if (token.isFunc) {

                if (token.func.equalsIgnoreCase("sin"))
                    return Math.sin(calc(vector));
                else if (token.func.equalsIgnoreCase("cos"))
                    return Math.cos(calc(vector));
                else if (token.func.equalsIgnoreCase("tan"))
                    return Math.tan(calc(vector));
                else

                if (token.func.equalsIgnoreCase("asin"))
                    return Math.asin(calc(vector));
                else if (token.func.equalsIgnoreCase("acos"))
                    return Math.acos(calc(vector));
                else if (token.func.equalsIgnoreCase("atan")) return Math.atan(calc(vector));

                if (token.func.equalsIgnoreCase("sinh"))
                    return Math.sinh(calc(vector));
                else if (token.func.equalsIgnoreCase("cosh"))
                    return Math.cosh(calc(vector));
                else if (token.func.equalsIgnoreCase("tanh"))
                    return Math.tanh(calc(vector));
                else

                if (token.func.equalsIgnoreCase("abs"))
                    return Math.abs(calc(vector));
                else if (token.func.equalsIgnoreCase("log"))
                    return Math.log10(calc(vector));
                else if (token.func.equalsIgnoreCase("ln"))
                    return Math.log(calc(vector));
                else if (token.func.equalsIgnoreCase("exp"))
                    return Math.exp(calc(vector));
                else

                if (token.func.equalsIgnoreCase("sqrt"))
                    return Math.sqrt(calc(vector));
                else if (token.func.equalsIgnoreCase("round"))
                    return Math.round(calc(vector));
                else if (token.func.equalsIgnoreCase("fak"))
                    return fakultaet(calc(vector));
                else if (token.func.equalsIgnoreCase("toDeg"))
                    return Math.toDegrees(calc(vector));
                else if (token.func.equalsIgnoreCase("toRad")) return Math.toRadians(calc(vector));
            }
        }
        ...
        for (int i = 0; i < tokenListe.size(); i++) {
            ...
            if (token.isVar) {
                if (varExist(token.str)) {
                    ...
                    setErrorMessage("Variable " + token.str + " existiert nicht!");
