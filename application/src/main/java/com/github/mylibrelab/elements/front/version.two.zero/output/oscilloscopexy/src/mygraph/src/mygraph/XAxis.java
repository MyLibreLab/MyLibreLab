...
package com.github.mylibrelab.elements.front.version.two.zero.output.oscilloscopexy.src.mygraph.src.mygraph;
...
public class XAxis {
     ...
     */
    public XAxis(JPanel owner, int x, int y, int width, double stepInProzent) {
        this.owner = owner;
        this.x = x;
        this.y = y;
        this.width = width;
        ...
        if (width > 1) {
            ...
            if (value != null) {
                ...
                if (cc > 0) {
                    ...
                    if (textOrientation == TOP) {
                        g.drawString(value, (int) cc, y - 5 - fm.getDescent());
                    } else if (textOrientation == BOTTOM) {
                        g.drawString(value, (int) cc, y + 10 + fm.getAscent());
                    }
                }
            }
        }
