...
package com.github.mylibrelab.elements.circuit.booleanpackage.counter.fourbitcounter;/*
                                                                                      * Copyright (C) 2020 MyLibreLab
...
public class Counter4Bit extends JVSMain {
    private final int width = 35 + 20;
    private final int height = 45;
    private Image image;
    private String imagePath;
    private boolean oldPin4 = false;
    private final boolean oldPin5 = false;
    private final boolean oki = true;

    private VSBoolean inTimer;
    private VSBoolean inReset;

    private final VSBoolean out1 = new VSBoolean();
    private final VSBoolean out2 = new VSBoolean();
    private final VSBoolean out3 = new VSBoolean();
    private final VSBoolean out4 = new VSBoolean();
