...
package com.github.mylibrelab.elements.front.twoautomation.industrial.buttons.jv.button.three.jv;/*
                                                                                                  * Copyright (C) 2020
                                                                                                  * MyLibreLab
                                                                                                  * Based on MyOpenLab
                                                                                                  * by Carmelo Salafia
...
public class TasterPanel extends JVSMain {
    ...
    private final VSBoolean invert = new VSBoolean(false);
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            if (down.getValue() == false) {
                ...
                tWidth = (int) ((r.width * 0.7));
                Y0 = (int) ((r.height * 0.3));
                X0 = (int) ((r.height * 0.05));
                g2.setStroke(strokeLine);
                shadowDarkColor.setFillColor(g2);
                g2.fillRect(X0, Y0, tWidth + 5, tHeight);
                buttonLigthColor.setFillColor(g2);
                g2.fillRect(X0, Y0, tWidth, tHeight);

                g2.setColor(Color.WHITE);
                if (invert.getValue()) {
                    g2.fillRect(X0 + (3 * tWidth / 4), (Y0 + tHeight / 2) - (tHeigthShadow / 2), tWidth / 4,
                            tHeigthShadow);
                } else {
    ...
    public void setPropertyEditor() {
        ...
        element.jAddPEItem("Button Invert", invert, 0, 0);
    ...
    private void localize() {
        ...
        element.jSetPEItemLocale(d + i++, language, "Button Invert");
        ...
        element.jSetPEItemLocale(d + i++, language, "Invertir Giro");
    }
