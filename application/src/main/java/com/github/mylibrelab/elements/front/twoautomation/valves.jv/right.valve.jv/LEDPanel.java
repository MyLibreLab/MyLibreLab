package com.github.mylibrelab.elements.front.twoautomation.valves.jv.right.valve.jv;/*
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            if (manualValve.getValue() == false) {
                ...
                X0 = element.jGetWidth() - (ValveSize + stroke.getValue());
                ...
                if (Diaphragm.getValue()) {
                    g2.fillArc(X0 - tWidth, Y0, tWidth * 2, tHeight, 90, -180);
                } else {
                ...
                if (Diaphragm.getValue()) {
                    g2.drawArc(X0 - tWidth, Y0, tWidth * 2, tHeight, 90, -180);
                } else {
                    if (roundValve.getValue()) {
