...
package com.github.mylibrelab.elements.circuit.vectorenmatrix.twodintegertotwodstring;/*
                                                                                       * Copyright (C) 2020 MyLibreLab
...
public class Element extends JVSMain {
    ...
    private VS2DInteger in;
    private final VS2DString out = new VS2DString(0, 0);
    ...
    public void init() {
        ...
        setPin(1, ExternalIF.C_ARRAY2D_INTEGER, element.PIN_INPUT); // IN

        setName("2DIntegerTo2DString");
    }

    public void initInputPins() {
        in = (VS2DInteger) element.getPinInputReference(1);
        if (in == null) in = new VS2DInteger(0, 0);
    }
    ...
    private void convert_2DInteger_to_2DString(VS2DInteger in) {
    ...
    public void process() {
        ...
        convert_2DInteger_to_2DString(in);
