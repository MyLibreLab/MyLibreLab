...
package com.github.mylibrelab.elements.circuit.vectorenmatrix.oneddoubletoonedstring;/*
                                                                                      * Copyright (C) 2020 MyLibreLab
...
public class Element extends JVSMain {
    ...
    private void convert_1DDouble_to_1DString(VS1DDouble in) {
    ...
    public void process() {
        ...
        if (in instanceof VS1DDouble) {
            convert_1DDouble_to_1DString(in);
