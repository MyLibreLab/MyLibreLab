package com.github.mylibrelab.elements.front.twostring.html.text.indicator.jv;/*
...
public class Pane_Text_Indicator_JV extends JVSMain implements PanelIF {
    ...
    public void processPanel(int pinIndex, double value, Object obj) {
        if (obj instanceof VSString) {
            ...
            // Auto Scroll when needed J.V. </p></body></html>");
            element.jRepaint();
        }
    }
    ...
    public void init() {
        ...
        text.setContentType("text/html");
        text.setText(
                "<HTML> <HEAD> <TITLE>Example 1 JV</TITLE> </HEAD> <BODY> HTML Ausgabe Preview.<BR> <FONT SIZE=\"1\">Text Size 1.</FONT><BR> <FONT SIZE=\"2\">Text Size 2.</FONT><BR> <FONT SIZE=\"4\">Text Size 4.</FONT><BR> <FONT SIZE=\"+1\">Text Size +1 (Same Size 4).</FONT><BR> <FONT FACE=\"Arial\" SIZE=\"5\" COLOR=\"F39C12\">Formated Text JV.</FONT> </BODY> </HTML>");
