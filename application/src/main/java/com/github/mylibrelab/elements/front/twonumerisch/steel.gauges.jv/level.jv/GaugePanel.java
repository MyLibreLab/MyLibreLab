package com.github.mylibrelab.elements.front.twonumerisch.steel.gauges.jv.level.jv;/*
...
public class GaugePanel extends JVSMain implements PanelIF {
    ...
    final private static Level myGauge = new Level();
    ...
    private void localize() {
        ...
        element.jSetPEItemLocale(d + 2, language, "Init Value");
        element.jSetPEItemLocale(d + 3, language, "Pointer Color");
        element.jSetPEItemLocale(d + 4, language, "Background_Visible");
        element.jSetPEItemLocale(d + 5, language, "Background_Color");
        element.jSetPEItemLocale(d + 6, language, "Frame_Visible");
        element.jSetPEItemLocale(d + 7, language, "Frame_Design");
        // element.jAddPEItem("Treshold_Indicator",tresholdIndicatorEn, 0,0);
        // element.jAddPEItem("Treshold_LED_Visible",tresholdLedIndicatorEn, 0,0);
        // element.jAddPEItem("LED_Color",ledColor, 0,0);
        // element.jAddPEItem("Treshold_Value",tresholdValue,-9999999.0,99999999.0);
        ...
        element.jSetPEItemLocale(d + 2, language, "Valor Inicial");
        element.jSetPEItemLocale(d + 3, language, "Color del Apuntador");
        element.jSetPEItemLocale(d + 4, language, "Ver Fondo");
        element.jSetPEItemLocale(d + 5, language, "Color de Fondo");
        element.jSetPEItemLocale(d + 6, language, "Ver Marco");
        element.jSetPEItemLocale(d + 7, language, "Diseño del Marco");
    }
