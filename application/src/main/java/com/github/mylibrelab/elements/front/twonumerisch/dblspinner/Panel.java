...
package com.github.mylibrelab.elements.front.twonumerisch.dblspinner;/*
                                                                      * Copyright (C) 2020 MyLibreLab
...
public class Panel extends JVSMain {
    ...
    private void make() {
        SpinnerNumberModel model = new SpinnerNumberModel(new Double(initValue.getValue()), new Double(min.getValue()),
                new Double(max.getValue()), new Double(step.getValue()));
