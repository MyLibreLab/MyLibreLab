...
package com.github.mylibrelab.elements.circuit.Interface.Raspberry_JV.Write_DO_RPI_JV.src;// ********************************
...
public class Write_DO_RPI_JV extends JVSMain {
    ...
    public void process() {
        ...
        if (Enable_VM_in.getValue() == true && State_DO_in.getValue() != Old_DO_State) { // Refresh DO State only if is
                                                                                         // different.
            Refresh_DO_State = true;
        } else {
