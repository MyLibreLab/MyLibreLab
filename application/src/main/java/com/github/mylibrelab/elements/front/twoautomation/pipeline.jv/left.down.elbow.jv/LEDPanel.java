...
package com.github.mylibrelab.elements.front.twoautomation.pipeline.jv.left.down.elbow.jv;/*
                                                                                           * Copyright (C) 2020
                                                                                           * MyLibreLab
...
public class LEDPanel extends JVSMain implements PanelIF {
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            // X0 = (stroke.getValue()/2) +BorderSize+stroke.getValue() - (((element.jGetWidth() -
            // ((BorderSize+stroke.getValue())))-stroke.getValue())/4);
            // Y0 = stroke.getValue()/2 + (element.jGetHeight()/4) + (element.jGetHeight()/16);

            X0 = -(int) (element.jGetWidth() * 0.03);
            // X0=-20;
