...
package com.github.mylibrelab.elements.front.twonumerisch.switchpackage.jv;/*
                                                                            * Copyright (C) 2020 MyLibreLab
...
class Beschriftung extends JPanel {
    ...
    public Beschriftung(TasterPanel owner, String text) {
        this.text = text;
        this.owner = owner;
        this.setBackground(owner.backColor.color1);
    ...
    public void paintComponent(java.awt.Graphics g) {
        ...
        // if (visible)
        {
            ...
            g2.setFont(owner.font.getValue());
            g2.setColor(owner.fontColor.getValue());

            java.awt.FontMetrics fm = g2.getFontMetrics(g2.getFont());

            g2.drawString(text, 1, 0 + fm.getMaxAscent());
        }
    }
}
...
public class MultiSwitch extends javax.swing.JPanel {
    ...
    public MultiSwitch(ExternalIF element, TasterPanel panel) {
        ...
        linesColor = panel.linesColor;
        edgeColor = panel.edgeColor;
        strokeColor = panel.strokeColor;
        strokeValue = panel.strokeValue;
    ...
    private void drawRect(Graphics g, int x, int y, int width, int height) {
        ...
        g2.setColor(linesColor.getValue());
        ...
        for (int i = 1; i < 4; i++) {
            ...
            g2.setColor(edgeColor.getValue());
            g2.drawLine(x + w, d, x + width - w, d);
            // g.setColor(Color.BLACK);
            g2.setColor(linesColor.getValue());
            g2.drawLine(x + w, d + 1, x + width - w, d + 1);
        }
    ...
    public void paintComponent(Graphics g) {
        ...
        drawRect(g2, x, y, getWidth() - 1 - x * 2, d - x * 2);

        moveDescriptions(g2, d - x * 2);
        // g.setColor(Color.WHITE);
