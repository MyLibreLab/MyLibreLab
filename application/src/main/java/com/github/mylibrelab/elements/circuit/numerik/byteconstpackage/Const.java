...
package com.github.mylibrelab.elements.circuit.numerik.byteconstpackage;// *****************************************************************************
...
public class Const extends JVSMain {
    ...
    private final VSByte constValue = new VSByte((byte) 0);
    private Graphics2D g2;
    private final Font fnt = new Font("Courier", 0, 12);
    private final VSByte out = new VSByte();
