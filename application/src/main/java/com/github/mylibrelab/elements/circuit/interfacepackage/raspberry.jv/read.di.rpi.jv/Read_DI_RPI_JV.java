...
package com.github.mylibrelab.elements.circuit.interfacepackage.raspberry.jv.read.di.rpi.jv;// ********************************
...
public class Read_DI_RPI_JV extends JVSMain {
    ...
    public void process() {
        ...
        if ((Enable_VM_in.getValue() == true && Error_in.getValue() == false)
                || (Enable_VM_in.getValue() == true && first_time == true)) // Execute the first time and if there are
                                                                            // error to continue trying.
        {
            ...
            try {
                ...
                if (Debug_Window_En_in.getValue()) {
                    element.jConsolePrintln(Element_Tag + Debug_Tag + "|Executing:" + "gpio read "
                            + wPi_Pin_Number_in.getValue() + "|");
                }
                ...
                if (Debug_Window_En_in.getValue()) {
                    element.jConsolePrintln(Element_Tag + Error_Tag + "|Command Error: gpio read "
                            + wPi_Pin_Number_in.getValue() + "|");
                }
                Error_out.setValue(true);
