...
package com.github.mylibrelab.elements.circuit.interfacepackage.serialcom.jv.serialport.transaction.jv;
// ********************************
            ...
            try {
                ...
                if (Debug_Window_En_in.getValue()) {
                    element.jConsolePrintln(
                            Element_Tag + "Proccessing Write to Serial Port: " + SerialPortNameIn.getValue());
                }
