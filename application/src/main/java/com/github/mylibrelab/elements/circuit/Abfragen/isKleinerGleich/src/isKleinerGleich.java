...
package com.github.mylibrelab.elements.circuit.Abfragen.isKleinerGleich.src;// *****************************************************************************
...
public class isKleinerGleich extends JVSMain {
    private Image image;
    ...
    public void process() {
        ...
        if (inA != null && inB != null && out != null) {
            if (inA.isSmaller(inB) || inA.equals(inB)) {
                out.setValue(true);
            } else
                out.setValue(false);
            element.notifyPin(0);
