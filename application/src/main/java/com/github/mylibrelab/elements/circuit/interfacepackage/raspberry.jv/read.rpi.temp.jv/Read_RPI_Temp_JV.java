...
package com.github.mylibrelab.elements.circuit.interfacepackage.raspberry.jv.read.rpi.temp.jv;// ********************************
...
public class Read_RPI_Temp_JV extends JVSMain {
    ...
    public void process() {
        ...
        if ((Enable_VM_in.getValue() == true && first_time == true && Error_in.getValue() == false)
                || (Enable_VM_in.getValue() == true && Error_in.getValue() == false)) // Execute the first time and if
                                                                                      // there are error to continue
                                                                                      // trying.
        {
