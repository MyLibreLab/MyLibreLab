...
package com.github.mylibrelab.elements.front.tworobotics.robotcanvas.one.one;/*
                                                                              * Copyright (C) 2020 MyLibreLab
...
import RobotSimulator1.PanelSimul;
import RobotSimulator1.RobotSensorIF;
    ...
    public void processPanel(int pinIndex, double value, Object obj) {
                ...
                if (o instanceof VSGroup) {
                    ...
                    if (tmp.list.size() == 3) {
                        ...
                        if (tmp.list.get(0) instanceof VSImage24) {
                            ...
                            imgX = Toolkit.getDefaultToolkit().createImage(new MemoryImageSource(vsimg.getWidth(),
        ...
        if (pinIndex == 17 && obj instanceof VSImage24) {
            ...
            Image img = Toolkit.getDefaultToolkit().createImage(
                    new MemoryImageSource(vsimg.getWidth(), vsimg.getHeight(), vsimg.getPixels(), 0, vsimg.getWidth()));
