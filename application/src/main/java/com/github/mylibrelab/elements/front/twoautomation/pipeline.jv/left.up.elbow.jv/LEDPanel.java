...
package com.github.mylibrelab.elements.front.twoautomation.pipeline.jv.left.up.elbow.jv;/*
                                                                                         * Copyright (C) 2020 MyLibreLab
...
public class LEDPanel extends JVSMain implements PanelIF {
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            X0 = -(int) (element.jGetWidth() * 0.025);
            // X0=-20;
            Y0 = -(int) (element.jGetHeight() * 0.05);
            // Y0=0;
            ...
            g2.setStroke(new BasicStroke(stroke.getValue()));
            try {
                g2.fillArc(X0, Y0, tWidth, tHeight, 0, -90);
            } catch (Exception e) {
            ...
            if (overlay)
                ...
                StrokeColor.setFillColor(g2);
            try {
                g2.drawArc(X0, Y0, tWidth, tHeight, 0, -90);
            } catch (Exception e) {
