...
package com.github.mylibrelab.elements.front.twonumerisch.colorbar.jv;/*
                                                                       * Copyright (C) 2020 MyLibreLab
...
public class AnzeigePanel extends JVSMain implements PanelIF {
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            GradientPaint gp =
                    new GradientPaint(0.0f, 50.0f, color1.getValue(), (float) bounds.width, 50.0f, color2.getValue());
            g2.setPaint(gp);
            ...
            if (RoundRect.getValue()) {
                g2.fillRoundRect((bounds.x) + 3 * ((bounds.width - 1) / 8), bounds.height - (int) stand,
                        (bounds.width - 1) / 4, (int) stand - 1, 0, 0);
            } else {
            ...
            if (RoundRect.getValue()) {
                ...
                g2.drawLine((bounds.x) + 3 * ((bounds.width - 1) / 8), bounds.height - (int) stand,
                        (bounds.x) + 5 * ((bounds.width - 1) / 8), bounds.height - (int) stand);
            } else {
    ...
    public void propertyChanged(Object o) {
        ...
        if (o.equals(RoundRect)) {
            if (RoundRect.getValue())
                edgeStroke.setValue(2);
            else
                edgeStroke.setValue(5);
        }
