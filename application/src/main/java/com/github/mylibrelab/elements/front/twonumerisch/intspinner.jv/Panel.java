...
package com.github.mylibrelab.elements.front.twonumerisch.intspinner.jv;/*
                                                                         * Copyright (C) 2020 MyLibreLab
...
public class Panel extends JVSMain {
    ...
    private void make() {
        SpinnerNumberModel model = new SpinnerNumberModel(new Integer(initValue.getValue()),
                new Integer(min.getValue()), new Integer(max.getValue()), new Integer(step.getValue()));
