...
package com.github.mylibrelab.elements.front.twonumerisch.steel.gauges.jv.radial.jv;/*
                                                                                     * Copyright (C) 2020 MyLibreLab
...
public class GaugePanel extends JVSMain implements PanelIF {
    ...
    final private static Radial myGauge = new Radial();
    ...
    private VSBoolean marksInverted = new VSBoolean(false);
    ...
    public void GaugeSet() {
        if (element != null) {
            ...
            if (marksInverted.getValue()) {
                myGauge.setTickmarkDirection(Direction.COUNTER_CLOCKWISE);
            } else {
                myGauge.setTickmarkDirection(Direction.CLOCKWISE);
            }
    ...
    public void setPropertyEditor() {
        ...
        element.jAddPEItem("Tick Marks Inverted", marksInverted, 0, 0);
    ...
    private void localize() {
        ...
        element.jSetPEItemLocale(d + 16, language, "Tick Marks Inverted");

        element.jSetPEItemLocale(d + 17, language, "Major Ticks");
        element.jSetPEItemLocale(d + 18, language, "Minor Ticks");
        element.jSetPEItemLocale(d + 19, language, "LogScale");
        element.jSetPEItemLocale(d + 20, language, "Label Number Format");

        element.jSetPEItemLocale(d + 21, language, "Pointer_Color");
        element.jSetPEItemLocale(d + 22, language, "Background_Visible");
        element.jSetPEItemLocale(d + 23, language, "Background_Color");
        element.jSetPEItemLocale(d + 24, language, "Frame_Visible");
        element.jSetPEItemLocale(d + 25, language, "Frame_Design");
        element.jSetPEItemLocale(d + 26, language, "Threshold_Indicator");
        element.jSetPEItemLocale(d + 27, language, "Threshold_LED_Visible");
        element.jSetPEItemLocale(d + 28, language, "LED_Color");
        element.jSetPEItemLocale(d + 29, language, "Threshold_Value");
        element.jSetPEItemLocale(d + 30, language, "Track_Enable");
        element.jSetPEItemLocale(d + 31, language, "Track_Start_Value");
        element.jSetPEItemLocale(d + 32, language, "Track_Section_Value");
        element.jSetPEItemLocale(d + 33, language, "Track_Stop_Value");
        ...
        element.jSetPEItemLocale(d + 16, language, "Marquillas Invertidas");

        element.jSetPEItemLocale(d + 17, language, "Divisones Mayores");
        element.jSetPEItemLocale(d + 18, language, "Divisiones Menores");
        element.jSetPEItemLocale(d + 19, language, "Escala Logaritmica");
        element.jSetPEItemLocale(d + 20, language, "Formato de Etiquetas");

        element.jSetPEItemLocale(d + 21, language, "Color de Aguja");
        element.jSetPEItemLocale(d + 22, language, "Fondo Visible");
        element.jSetPEItemLocale(d + 23, language, "Color de Fondo");
        element.jSetPEItemLocale(d + 24, language, "Marco Visible");
        element.jSetPEItemLocale(d + 25, language, "Estilo de marco");
        element.jSetPEItemLocale(d + 26, language, "Indicator de Umbral");
        element.jSetPEItemLocale(d + 27, language, "LED de Umbral Visible");
        element.jSetPEItemLocale(d + 28, language, "Color del LED");
        element.jSetPEItemLocale(d + 29, language, "Valor de Umbral");
        element.jSetPEItemLocale(d + 30, language, "Habilitar Pista");
        element.jSetPEItemLocale(d + 31, language, "Valor Inicio de Pista");
        element.jSetPEItemLocale(d + 32, language, "Valor Seccion de pista");
        element.jSetPEItemLocale(d + 33, language, "Valor final de Pista");
    ...
    public void loadFromStream(java.io.FileInputStream fis) {
        ...
        marksInverted.loadFromStream(fis);
    ...
    public void saveToStream(java.io.FileOutputStream fos) {
        ...
        marksInverted.saveToStream(fos);
