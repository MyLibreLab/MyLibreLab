...
package com.github.mylibrelab.elements.front.twoautomation.tanks.jv.tank.six.jv;/*
                                                                                 * Copyright (C) 2020 MyLibreLab
...
public class AnzeigePanel extends JVSMain implements PanelIF {
    ...
    private final VSBoolean tankfillExpand = new VSBoolean(true);
    private final VSColor UpperFillColor = new VSColor(new Color(153, 204, 255));
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            tHeight = (element.jGetHeight()) - (2 * strokeValue.getValue());
            X0 = (int) (element.jGetWidth() * 0.5) - (tWidth / 2);
            Y0 = strokeValue.getValue();
            ...
            tHeight = (int) ((element.jGetHeight() * 0.9) - (2 * strokeValue.getValue()));
