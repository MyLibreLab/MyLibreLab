package com.github.mylibrelab.elements.front.twoautomation.valves.jv.up.valve.jv;/*
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            if (manualValve.getValue() == false) {
                ...
                Y0 = (element.jGetHeight() / 2) - tHeight;
                // Y0-=tHeight;
            ...
            if (manualValve.getValue() == false) {
                ...
                if (Diaphragm.getValue()) {
                    g2.fillArc(X0, Y0, tWidth, tHeight * 2, 0, 180);
                } else {
                ...
                if (Diaphragm.getValue()) {
                    g2.drawArc(X0, Y0, tWidth, tHeight * 2, 0, 180);
                } else {
                    if (roundValve.getValue()) {
