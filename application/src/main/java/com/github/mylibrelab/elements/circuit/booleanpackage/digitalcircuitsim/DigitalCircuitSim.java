...
package com.github.mylibrelab.elements.circuit.booleanpackage.digitalcircuitsim;// *****************************************************************************
...
public class DigitalCircuitSim extends JVSMain {
    ...
    private final VSString inputColumns = new VSString("");
    private final VSString outputColumns = new VSString("");
    private final VS1DString inputString = new VS1DString(4);
    private final VS1DString outputString = new VS1DString(4);
    private VSBoolean[] in;
    private VSBoolean[] out;

    private final VSInteger inputs = new VSInteger(2);
    private final VSInteger outputs = new VSInteger(1);
    ...
    private void initAllPins() {
        ...
        width = 60;
        if (outputs.getValue() > inputs.getValue())
            height = 20 + 10 * outputs.getValue();
        else
            height = 20 + 10 * inputs.getValue();
