...
package com.github.mylibrelab.elements.front.tworobotics.robotcanvas;/*
                                                                      * Copyright (C) 2020 MyLibreLab
...
public class RobotCanvas extends JVSMain {
    ...
    private VSBoolean outPosChanged = new VSBoolean(false); // posChanged(x,y,alpha)
    ...
    public void init() {
        ...
        setPin(6, ExternalIF.C_BOOLEAN, element.PIN_OUTPUT); // PosChanged(x,y,Alpha)
        ...
        element.jSetPinDescription(6, "Position Changed [Event]");
    ...
    public void initOutputPins() {
        ...
        element.setPinOutputReference(6, outPosChanged);
    ...
    public void changePin(int pinIndex, Object value) {
        ...
        if (pinIndex == 6 && value instanceof VSBoolean) {
            ...
            if (inRecord.getValue()) {
                double[][] values =
                        addToData(outX.getValue(), outY.getValue(), outAlpha.getValue(), inSpeed.getValue());
