...
package com.github.mylibrelab.elements.circuit.Interface.RS232_1_2.src;// *****************************************************************************
...
public class RS232 extends JVSMain implements MyOpenLabDriverOwnerIF {
    ...
    private final VSBoolean RTS = new VSBoolean(false);
    private final VSBoolean DTR = new VSBoolean(false);
    ...
    public void start() {
        ...
        if (RTS.getValue())
            driver.sendCommand(strCom + ";RTSON", "");
        else
            driver.sendCommand(strCom + ";RTSOFF", "");
        if (DTR.getValue())
            driver.sendCommand(strCom + ";DTRON", "");
        else
            driver.sendCommand(strCom + ";DTROFF", "");
