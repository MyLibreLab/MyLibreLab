...
package com.github.mylibrelab.elements.front.twonumerisch.rgb.led;/*
                                                                   * Copyright (C) 2020 MyLibreLab
    ...
    public void process() {
        ...
        if (inR != null && inG != null && inB != null) {
            if (inR.getValue() != oRed || inG.getValue() != oGreen || inB.getValue() != oBlue) {
                ...
                if (panelElement != null) panelElement.jProcessPanel(0, 0.0,
                        new Color((char) inR.getValue(), (char) inG.getValue(), (char) inB.getValue()));
                oRed = inR.getValue();
                oGreen = inG.getValue();
                oBlue = inB.getValue();
            }
