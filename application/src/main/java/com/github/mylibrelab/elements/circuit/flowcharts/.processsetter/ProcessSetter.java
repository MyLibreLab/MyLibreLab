...
package com.github.mylibrelab.elements.circuit.FlowCharts._ProcessSetter.src;// *****************************************************************************
    ...
    public void elementActionPerformed(ElementActionEvent evt) {
        ...
        if (evt.getSourcePinIndex() == 2) {
            if (input != null) {
                ...
                if (value == null) {
                    element.jShowMessage(
                            "Types unkompatible or variable unknown in expression : " + variable.getValue());
                } else {
