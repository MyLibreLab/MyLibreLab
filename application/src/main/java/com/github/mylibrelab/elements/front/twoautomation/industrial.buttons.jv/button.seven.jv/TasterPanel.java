...
package com.github.mylibrelab.elements.front.twoautomation.industrial.buttons.jv.button.seven.jv;/*
                                                                                                  * Copyright (C) 2020
                                                                                                  * MyLibreLab
                                                                                                  * Based on MyOpenLab
                                                                                                  * by Carmelo Salafia
...
public class TasterPanel extends JVSMain {
    ...
    private final VSInteger strokeValue = new VSInteger(3);
    ...
    private final VSBoolean roundButton = new VSBoolean(true);
    private final VSInteger arcRect = new VSInteger(20);
