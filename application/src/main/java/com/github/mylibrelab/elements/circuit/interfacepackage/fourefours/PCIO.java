...
package com.github.mylibrelab.elements.circuit.interfacepackage.fourefours;/*
                                                                            * Copyright (C) 2020 MyLibreLab
...
public class PCIO extends JVSMain implements MyOpenLabDriverOwnerIF {
    ...
    private final VSBoolean e0 = new VSBoolean();
    private final VSBoolean e1 = new VSBoolean();
    private final VSBoolean e2 = new VSBoolean();
    private final VSBoolean e3 = new VSBoolean();

    private final VSInteger a0 = new VSInteger();
    private final VSInteger a1 = new VSInteger();
    private final VSInteger a2 = new VSInteger();
    private final VSInteger a3 = new VSInteger();
