...
package com.github.mylibrelab.elements.circuit.interfacepackage.raspberry.jv.jvthree;// ********************************
...
public class Write_DO_RPI_JV extends JVSMain {
    ...
    public void process() {
        ...
        if (Error_in.getValue() == true && Enable_VM_in.getValue() == true) { // if There are error do not execute code
                                                                              // and out the error to handle in the
                                                                              // Error Handler VM.
        ...
        // Refresh DO State only if is
        // different.
        Refresh_DO_State = Enable_VM_in.getValue() == true && State_DO_in.getValue() != Old_DO_State;


        if ((Enable_VM_in.getValue() == true && first_time == true && Error_in.getValue() == false)
                || (Enable_VM_in.getValue() == true && Refresh_DO_State == true && Error_in.getValue() == false)) // Execute
                                                                                                                  // the
                                                                                                                  // first
                                                                                                                  // time
                                                                                                                  // and
                                                                                                                  ...
                                                                                                                  // trying.
        {
            ...
            try {
                ...
                Process p = Runtime.getRuntime().exec("gpio write " + wPi_Pin_Number_in.getValue() + " " + DO_State); // gpio
                                                                                                                      // write
                                                                                                                      // <pin>
                                                                                                                      // 0/1
                if (Debug_Window_En_in.getValue()) {
                    element.jConsolePrintln(Element_Tag + Debug_Tag + "|Executing:" + "gpio write "
                            + wPi_Pin_Number_in.getValue() + " " + DO_State + "|");
                }
                ...
                if (Debug_Window_En_in.getValue()) {
                    element.jConsolePrintln(Element_Tag + Error_Tag + "|Command Error: gpio write "
                            + wPi_Pin_Number_in.getValue() + " " + DO_State + "|");
                }
                Error_out.setValue(true);
