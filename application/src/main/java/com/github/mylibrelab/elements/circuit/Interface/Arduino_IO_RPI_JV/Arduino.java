...
package com.github.mylibrelab.elements.circuit.Interface.Arduino_IO_RPI_JV.src;// *****************************************************************************
        ...
        timer = new javax.swing.Timer(pollTime.getValue(), new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                if (started && driver != null) {
                    ...
                    if (led1.getValue() || firstUpdate)
                        value |= (1 << 0);
                    else
                        value &= ~(1 << 0);
                    if (led2.getValue() || firstUpdate)
                        value |= (1 << 1);
                    else
                        value &= ~(1 << 1);
                    if (led3.getValue() || firstUpdate)
                        value |= (1 << 2);
                    else
                        value &= ~(1 << 2);
                    if (led4.getValue() || firstUpdate)
                        value |= (1 << 3);
                    else
                        value &= ~(1 << 3);
                    if (led5.getValue() || firstUpdate)
                        value |= (1 << 4);
                    else
                        value &= ~(1 << 4);
                    if (led6.getValue() || firstUpdate)
                        value |= (1 << 5);
                    else
                        value &= ~(1 << 5);
        ...
        if (value instanceof VS1DByte) {
            ...
            if (commando.equals("BYTESRECEIVED")) {
                ...
                if (len == 13) {
                    ...
                    if (t1 != taste1.getValue() || firstUpdate) {
                        taste1.setValue(t1);
                        element.notifyPin(0);
                    }
                    if (t2 != taste2.getValue() || firstUpdate) {
                        taste2.setValue(t2);
                        element.notifyPin(1);
                    }
                    if (t3 != taste3.getValue() || firstUpdate) {
                        taste3.setValue(t3);
                        element.notifyPin(2);
                    }
                    if (t4 != taste4.getValue() || firstUpdate) {
                        taste4.setValue(t4);
                        element.notifyPin(3);
                    }
                    if (t5 != taste5.getValue() || firstUpdate) {
                        taste5.setValue(t5);
                        element.notifyPin(4);
                    }
                    if (t6 != taste6.getValue() || firstUpdate) {
                        taste6.setValue(t6);
                        element.notifyPin(5);
                    }
                    firstUpdate = false;
                    ...
                    if (xadc1 != adc1.getValue()) {
                        adc1.setValue(xadc1);
                        element.notifyPin(6);
                    }
                    if (xadc2 != adc2.getValue()) {
                        adc2.setValue(xadc2);
                        element.notifyPin(7);
                    }
                    if (xadc3 != adc3.getValue()) {
                        adc3.setValue(xadc3);
                        element.notifyPin(8);
                    }
                    if (xadc4 != adc4.getValue()) {
                        adc4.setValue(xadc4);
                        element.notifyPin(9);
                    }
                    if (xadc5 != adc5.getValue()) {
                        adc5.setValue(xadc5);
                        element.notifyPin(10);
                    }
                    if (xadc6 != adc6.getValue()) {
                        adc6.setValue(xadc6);
                        element.notifyPin(11);
                    }
