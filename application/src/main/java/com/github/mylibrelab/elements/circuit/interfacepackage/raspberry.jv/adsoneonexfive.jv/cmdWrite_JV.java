...
package com.github.mylibrelab.elements.circuit.interfacepackage.raspberry.jv.adsoneonexfive.jv;// ********************************
            ...
            try {
                ...
                try {
                    ...
                    if (tmp.contains("|") && tmp.length() >= 36) {
                        ...
                        // System.err.println("Split L: " + firstSeparator + " " + secondSeparator + " " +
                        // thirdSeparator
                        ...
                        if (Debug_En.getValue()) {
                            element.jConsolePrintln(
                                    "I2C Device communication Parameters or Library not Installed error: "
                                            + sysOut_N_Err + " Command:" + CommandIn.getValue());
                        }
                        Response_Out.setValue(
                                "I2C Device communication Parameters or Library not Installed error!! " + sysOut_N_Err);
                    }
                } catch (Exception e) {
                    Error_out.setValue(true);
                    ...
                    if (Debug_En.getValue()) {
                        element.jConsolePrintln(
                                "Error Response Format: " + sysOut_N_Err + " Command:" + CommandIn.getValue());
                    }
