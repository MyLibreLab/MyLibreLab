...
public class DocumentationGroup extends AnActionGroup {

    public DocumentationGroup() {
        getPresentation().setDisplayName(Resources.getResourceText("actions.groups.documentation.displayName"));
    }
