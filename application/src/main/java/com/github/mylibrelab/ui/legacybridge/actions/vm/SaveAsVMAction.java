...
@Action
@ParentGroup(groups = VMActionGroup.class)
public class SaveAsVMAction extends BasicAction {

    public SaveAsVMAction() {
        super(Resources.getResourceText("actions.saveVMAs.displayName"));
    }
