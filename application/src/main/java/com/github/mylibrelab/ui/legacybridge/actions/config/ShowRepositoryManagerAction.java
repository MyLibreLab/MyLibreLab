...
public class ShowRepositoryManagerAction extends BasicAction {

    public ShowRepositoryManagerAction() {
        super(Resources.getResourceText("actions.showRepository.displayName"));
    }
