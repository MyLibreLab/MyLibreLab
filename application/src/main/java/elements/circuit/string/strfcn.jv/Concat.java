...
package elements.circuit.string.strfcn.jv;// *****************************************************************************
...
public class Concat extends JVSMain {
    ...
    public void paint(java.awt.Graphics g) {
        ...
        if (g2 != null && element != null) {
            ...
            g2.drawString(tempStr2, (int) ((r.x + (r.width / 2)) - (rFont.getWidth() / 2)),
                    (int) ((r.y + (r.height / 2)) + (rFont.getHeight() / 4)));
        ...
        switch (Strfunction.selectedIndex) {
            ...
            case 8: // ----------------------------------------------------------INDEX OF (int Char, int fromIndex)
                if (inAStr != null && inAInt != null && inBInt != null) {
                    String temp = inAStr.getValue() + inAInt.getValue() + inBInt.getValue(); // To detect if A or B
                                                                                             // Changes
                    int indexOut = 0;
                    try {
            ...
            case 10: // ------------------------------------------------INDEX OF (String str, int fromIndex)
                if (inAStr != null && inBStr != null && inAInt != null) {
                    String temp = inAStr.getValue() + inBStr.getValue() + inAInt.getValue(); // To detect if A or B
                                                                                             // Changes
                    int indexOut = 0;
                    try {
