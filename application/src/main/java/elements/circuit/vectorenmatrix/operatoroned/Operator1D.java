...
package elements.circuit.vectorenmatrix.operatoroned;// *****************************************************************************
...
public class Operator1D extends JVSMain {
    ...
    private final VSComboBox operator = new VSComboBox();
    ...
    public void checkPinDataType() {
        ...
        if (dtA == INT && dtB == INT)
            dtC = INT;
        else if (dtA == INT && dtB == DBL)
            dtC = DBL;
        else if (dtA == DBL && dtB == INT)
            dtC = DBL;
        else if (dtA == DBL && dtB == DBL)
            dtC = DBL;
        else if (dtA == INT_1D && dtB == INT_1D)
            dtC = INT_1D;
        else if (dtA == INT_1D && dtB == INT)
            dtC = INT_1D;
        else if (dtA == INT && dtB == INT_1D)
            dtC = INT_1D;
        else if (dtA == DBL_1D && dtB == DBL_1D)
            dtC = DBL_1D;
        else if (dtA == DBL_1D && dtB == DBL)
            dtC = DBL_1D;
        else if (dtA == DBL && dtB == DBL_1D)
            dtC = DBL_1D;
        else {
    ...
    public void INTArrayWithINT(VS1DInteger out, VS1DInteger array1, VSInteger value) {
        ...
        for (int i = 0; i < out.getLength(); i++) {
            switch (operator.selectedIndex) {
                case 0:
                    out.setValue(i, array1.getValue(i) + value.getValue());
                    break;
                case 1:
                    out.setValue(i, array1.getValue(i) - value.getValue());
                    break;
    ...
    public void INTArrayWithINTX(VS1DInteger out, VS1DInteger array1, VS1DInteger array2) {
        ...
        for (int i = 0; i < out.getLength(); i++) {
            switch (operator.selectedIndex) {
                case 0:
                    out.setValue(i, array1.getValue(i) + array2.getValue(i));
                    break;
                case 1:
                    out.setValue(i, array1.getValue(i) - array2.getValue(i));
                    break;
        ...
        if (inA != null && inB != null) {
            // if (inA.isChanged() || inB.isChanged())
            {
                ...
                if (dtA == INT && dtB == INT) {
                    ...
                    switch (operator.selectedIndex) {
                        case 0:
                            o.setValue((double) a.getValue() + b.getValue());
                            break;
                        case 1:
                            o.setValue((double) a.getValue() - b.getValue());
                            break;
                    ...
                    switch (operator.selectedIndex) {
                        case 0:
                            o.setValue(a.getValue() + (double) b.getValue());
                            break;
                        case 1:
                            o.setValue(a.getValue() - (double) b.getValue());
                            break;
