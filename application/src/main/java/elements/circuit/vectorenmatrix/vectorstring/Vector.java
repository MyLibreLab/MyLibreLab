...
package elements.circuit.vectorenmatrix.vectorstring;// *****************************************************************************

import java.awt.Image;

import elements.circuit.vectorenmatrix.vectorstring.src.mytableeditor.MyTableEditor;
...
public class Vector extends JVSMain {
    ...
    private Image image;
    private final VS1DString vector = new VS1DString(0);
    ...
    public void initOutputPins() {
        VS1DString ref = new VS1DString(0);
