...
package elements.circuit.mcu.stackinterpreter.loader;// *****************************************************************************
    ...
    private void interp() {
        ...
        while (pc < liste.size()) {
            ...
            if (tokens.length > 0) {
                ...
                if (token.equalsIgnoreCase("PROPERTY")) {
                    ...
                    if (tokens.length == 4 + 1) {
                        ...
                        if (strType.equalsIgnoreCase("STRING"))
                            ...
                            dt = DT_BYTE;
                        else if (strType.equalsIgnoreCase("WORD"))
                            dt = DT_WORD;
                        else
                ...
                } else if (token.equalsIgnoreCase("PIN_TYPE")) {
                    if (tokens.length == 4) {
                        ...
                        if (pinIndex > -1) {
                            ...
                            if (strType.equalsIgnoreCase("INTEGER"))
                                ...
                                pinType = PIN_DOUBLE;
                            else if (strType.equalsIgnoreCase("FLOWINFO"))
                                pinType = PIN_FLOWINFO;
                            else {
                ...
                } else if (token.equalsIgnoreCase("PINS_VISIBLE_TOP")) {
                    strPINS_VISIBLE_TOP = tokens[1].trim();
                } else if (token.equalsIgnoreCase("PINS_VISIBLE_RIGHT")) {
                    strPINS_VISIBLE_RIGHT = tokens[1].trim();
                } else if (token.equalsIgnoreCase("PINS_VISIBLE_BOTTOM")) {
                    strPINS_VISIBLE_BOTTOM = tokens[1].trim();
                } else if (token.equalsIgnoreCase("PINS_VISIBLE_LEFT")) {
                    strPINS_VISIBLE_LEFT = tokens[1].trim();
                } else if (token.equalsIgnoreCase("TopPins")) {
                    strTopPins = tokens[1].trim();
                } else if (token.equalsIgnoreCase("BottomPins")) {
                    strBottomPins = tokens[1].trim();
                } else if (token.equalsIgnoreCase("InputPins") || token.equalsIgnoreCase("LeftPins")) {
                    strLeftPins = tokens[1].trim();
                } else if (token.equalsIgnoreCase("OutPutPins") || token.equalsIgnoreCase("RightPins")) {
                    strRightPins = tokens[1].trim();
                } else if (inputString.equalsIgnoreCase("GLOBALS")) {
                    strGlobals = getBlock();
                } else if (inputString.equalsIgnoreCase("PAINT")) {
                    strPaint = getBlock();
                } else if (inputString.equalsIgnoreCase("INIT")) {
                    strInit = getBlock();
                } else if (inputString.equalsIgnoreCase("EVENT-HANDLER")) {
