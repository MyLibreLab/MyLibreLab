...
package elements.circuit.sockets.socketserver;// *****************************************************************************
...
public class SocketServer extends JVSMain {
    ...
    private final int status = STATUS_NOT_CONNECTED;
                    ...
                    if (obj != null) {
                        if (obj instanceof VSObject) {
                            ...
                            switch (vs.getPinIndex()) {
                                case 0:
                                    out0.copyValueFrom(vs);
                                    out0.setChanged(true);
                                    element.addToProcesslist(out0);
                                    break;
                                case 1:
                                    out1.copyValueFrom(vs);
                                    out1.setChanged(true);
                                    element.addToProcesslist(out1);
                                    break;
                                case 2:
                                    out2.copyValueFrom(vs);
                                    out2.setChanged(true);
                                    element.addToProcesslist(out2);
                                    break;
                                case 3:
                                    out3.copyValueFrom(vs);
                                    out3.setChanged(true);
                                    element.addToProcesslist(out3);
                                    break;
                                case 4:
                                    out4.copyValueFrom(vs);
                                    out4.setChanged(true);
                                    element.addToProcesslist(out4);
                                    break;
                                case 5:
                                    out5.copyValueFrom(vs);
                                    out5.setChanged(true);
                                    element.addToProcesslist(out5);
                                    break;
                                case 6:
                                    out6.copyValueFrom(vs);
                                    out6.setChanged(true);
                                    element.addToProcesslist(out6);
                                    break;
                                case 7:
                                    out7.copyValueFrom(vs);
                                    out7.setChanged(true);
                                    element.addToProcesslist(out7);
                                    break;
                            }
