...
package elements.circuit.interfacepackage.raspberry.gpio;// *****************************************************************************
...
public class Raspberry_GPIO extends JVSMain implements MyOpenLabDriverOwnerIF {
    ...
    private Image image;
    private final VS1DByte inBytes = new VS1DByte(1);
    private final ArrayList<String> cmd = new ArrayList<>();

    private final VSComboBox gpio_left_7 = new VSComboBox();
    private final VSComboBox gpio_left_0 = new VSComboBox();
    private final VSComboBox gpio_left_2 = new VSComboBox();
    private final VSComboBox gpio_left_3 = new VSComboBox();
    private final VSComboBox gpio_left_21 = new VSComboBox();
    private final VSComboBox gpio_left_22 = new VSComboBox();
    private final VSComboBox gpio_left_23 = new VSComboBox();
    private final VSComboBox gpio_left_24 = new VSComboBox();
    private final VSComboBox gpio_left_25 = new VSComboBox();

    private final VSComboBox gpio_right_1 = new VSComboBox();
    private final VSComboBox gpio_right_4 = new VSComboBox();
    private final VSComboBox gpio_right_5 = new VSComboBox();
    private final VSComboBox gpio_right_6 = new VSComboBox();
    private final VSComboBox gpio_right_26 = new VSComboBox();
    private final VSComboBox gpio_right_27 = new VSComboBox();
    private final VSComboBox gpio_right_28 = new VSComboBox();
    private final VSComboBox gpio_right_29 = new VSComboBox();
