...
package elements.circuit.flowcharts.forpackage;// *****************************************************************************
...
public class XFor extends MainFlow {
    ...
    private final VSString p_var = new VSString("i");
    private final VSString p_initValue = new VSString("0");
    private final VSString p_ToValue = new VSString("10");
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            String caption =
                    "FOR(" + p_var.getValue() + "=" + p_initValue.getValue() + " TO " + p_ToValue.getValue() + ")";
            // setValue(caption);
