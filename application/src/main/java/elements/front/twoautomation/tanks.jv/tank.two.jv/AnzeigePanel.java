...
package elements.front.twoautomation.tanks.jv.tank.two.jv;/*
                                                                                 * Copyright (C) 2020 MyLibreLab
    ...
    public void paint(java.awt.Graphics g) {
        if (element != null) {
            ...
            Rectangle bounds = new Rectangle(
                    (int) (element.jGetWidth() * 0.3), (int) (element.jGetHeight() * 0.25),
            ...
            tHeight = (int) ((element.jGetHeight() * 0.6) + (strokeValue.getValue() / 2));
            ...
            X0 = (int) (element.jGetWidth() * 0.5) - (tWidth / 2);
            Y0 = (int) (((element.jGetHeight() * 0.6)) + strokeValue.getValue());


            Polygon p = new Polygon();
            p.addPoint(X0, Y0);
            p.addPoint((X0 + tWidth), Y0);
            p.addPoint((X0 + (tWidth / 2)), Y0 + tHeight);
            ...
            if (overlay)
                ...
                strokeColor.setFillColor(g2);
            g2.drawLine(X0, Y0, (X0 + (tWidth)), Y0); // LINE DIVISION
            g2.drawLine(X0 + xOffset, Y0, (X0 + (tWidth / 2)), Y0 + tHeight - yOffset); // LINE \
            g2.drawLine((X0 + tWidth) - xOffset, Y0, (X0 + (tWidth / 2)), Y0 + tHeight - yOffset); // LINE /
            ...
            tHeight = (int) (element.jGetHeight() * 0.5);
            X0 = (int) (element.jGetWidth() * x0Percent) - (tWidth / 2);
            // Y0=(int)((element.jGetHeight()*0.01));
            Y0 = (int) (element.jGetHeight() * 0.08);
            int YMin = (Y0 + tHeight) - strokeValue.getValue();
            int YMax = Y0;
            double m = (YMin - YMax) / (0.0 - 100.0);
            double b = YMin;
            double y = (m * value) + b;
            // System.err.println("Valor EC: value="+value+"_m:"+m+"_b:"+b+"_Result:"+y
            ...
            if (value == 0) {
                ...
                GradientPaint gp = new GradientPaint(X0, X0 + (tWidth / 2), fillColor1.getValue(), (float) tWidth,
                        X0 + (tWidth / 2), fillColor2.getValue());
                g2.setPaint(gp);
