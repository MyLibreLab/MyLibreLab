...
package elements.front.twonumerisch.steel.gauges.jv.radial.bargraph.jv;/*
                                                                                              * Copyright (C) 2020
                                                                                              * MyLibreLab
...
public class GaugePanel extends JVSMain implements PanelIF {
        ...
        if (element != null) {
            ...
            for (ColorDef colorTemp : ColorDef.values()) {
                if (colorTemp.name().equalsIgnoreCase(pointerColor.getItem(pointerColor.selectedIndex))) {
                    myGauge.setBarGraphColor(colorTemp);
                }
            }
    ...
    public void setPropertyEditor() {
        ...
        element.jAddPEItem("BarGraph_Color", pointerColor, 0, 50);
    ...
    private void localize() {
        ...
        element.jSetPEItemLocale(d + 15, language, "Major Ticks");
        element.jSetPEItemLocale(d + 16, language, "Minor Ticks");
        element.jSetPEItemLocale(d + 17, language, "LogScale");
        element.jSetPEItemLocale(d + 18, language, "Label Number Format");

        element.jSetPEItemLocale(d + 19, language, "BarGraph_Color");
        element.jSetPEItemLocale(d + 20, language, "Background_Visible");
        element.jSetPEItemLocale(d + 21, language, "Background_Color");
        element.jSetPEItemLocale(d + 22, language, "Frame_Visible");
        element.jSetPEItemLocale(d + 23, language, "Frame_Design");

        element.jSetPEItemLocale(d + 24, language, "Threshold_LED_Visible");
        element.jSetPEItemLocale(d + 25, language, "LED_Color");
        element.jSetPEItemLocale(d + 26, language, "Threshold_Value");
        ...
        element.jSetPEItemLocale(d + 15, language, "Divisones Mayores");
        element.jSetPEItemLocale(d + 16, language, "Divisiones Menores");
        element.jSetPEItemLocale(d + 17, language, "Escala Logaritmica");
        element.jSetPEItemLocale(d + 18, language, "Formato de Etiquetas");

        element.jSetPEItemLocale(d + 19, language, "Color de Barra");
        element.jSetPEItemLocale(d + 20, language, "Fondo Visible");
        element.jSetPEItemLocale(d + 21, language, "Color de Fondo");
        element.jSetPEItemLocale(d + 22, language, "Marco Visible");
        element.jSetPEItemLocale(d + 23, language, "Estilo de marco");

        element.jSetPEItemLocale(d + 24, language, "LED de Umbral Visible");
        element.jSetPEItemLocale(d + 25, language, "Color del LED");
        element.jSetPEItemLocale(d + 26, language, "Valor de Umbral");
