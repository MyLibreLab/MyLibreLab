...
package elements.front.twonumerisch.balkenregler.jv;/*
                                                                           * Copyright (C) 2020 MyLibreLab
        ...
        if (element != null) {
            ...
            if (backgroundVisible.getValue()) {
                ...
                if (RoundBase.getValue()) {
                    ...
                    g2.fillRoundRect(bounds.x + bounds.width - 22, bounds.y + 5, 15 - 1, bounds.height - 10,
                            arcValue.getValue(), arcValue.getValue());
                    g2.setStroke(new BasicStroke(strokeValue.getValue()));
                    strokeColor.setFillColor(g2);
                    g2.drawRoundRect(bounds.x + bounds.width - 22, bounds.y + 5, 15 - 1, bounds.height - 10,
                            arcValue.getValue(), arcValue.getValue());
            ...
            if (circularNibble.getValue()) {
                ...
                if (EdgeVisible.getValue()) {
                    g2.setStroke(new BasicStroke(1));
                    g2.setColor(edgeColor.getValue());
                    g2.drawOval(bounds.x + bounds.width - 30, bounds.y + 1 + bounds.height - (int) stand - 5, 30 - 1,
                            8);
                }
                g2.setStroke(new BasicStroke(2));
                g2.setColor(Color.WHITE);
                g2.drawLine(bounds.x + bounds.width - 30 + 1, bounds.y + bounds.height - (int) stand,
                        bounds.x + bounds.width - 2, bounds.y + bounds.height - (int) stand);
                ...
                if (EdgeVisible.getValue()) {
                    g2.setStroke(new BasicStroke(1));
                    g2.setColor(edgeColor.getValue());
                    g2.drawRect(bounds.x + bounds.width - 30, bounds.y + 1 + bounds.height - (int) stand - 5, 30 - 1,
                            8);
                }
                g2.setStroke(new BasicStroke(2));
                g2.setColor(Color.WHITE);
