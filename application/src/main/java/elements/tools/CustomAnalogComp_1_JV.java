...
public class CustomAnalogComp_1_JV extends AbstractCustomAnalogComp {
    ...
    public void drawAnzeige(java.awt.Graphics gx, int x, int y, int w, int h) {
        ...
        if (showText.getValue()) {
            ...
            g.drawArc(distance + OffsetXY, distance + OffsetXY, w - distance * 2 + 2, h - distance * 2 + 2,
    ...
    public void generateFromValuesSubElements() {
        ...
        for (int i = 0; i < values.getLength(); i++) {
            ...
            Beschriftung<CustomAnalogComp_1_JV> bes = new Beschriftung(this, strValue);
