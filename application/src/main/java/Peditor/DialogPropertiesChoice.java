...
public class DialogPropertiesChoice extends javax.swing.JDialog implements ListSelectionListener {
    ...
    private final DefaultListModel<BasisProperty> model = new DefaultListModel<>();
    ...
    public void execute() {
        ...
        for (int i = 0; i < vmobject.propertyList.size(); i++) {
            BasisProperty prop = vmobject.propertyList.get(i);
            props.add(prop);
        }
        listProps();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (index >= 0) {
            BasisProperty p = props.get(index);
    ...
    private void listProps() {
        ...
        for (BasisProperty p : props) {
            ...
            if (el != null) {
                ElementProperty elProp = el.propertyList.get(p.propertyIndex);
                data[0] = el.toString();
                data[1] = elProp.label;
    ...
    public void listElementProperties(Element element) {
        ...
        for (int i = 0; i < element.propertyList.size(); i++) {
            ElementProperty elProp = element.propertyList.get(i);
