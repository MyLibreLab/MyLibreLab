...
public class VMEditorPanel extends javax.swing.JPanel implements ElementPaletteIF {
    ...
    private final Element oldElement = null;
    ...
    private final VMEditorPanelIF owner;
    ...
    private final boolean comboIsEditing = false;
    ...
    class MeinOutputStream extends OutputStream {
        ...
        public void write(int b) {
            char c = (char) b;
            anzeigeText.setText(anzeigeText.getText() + c);
        }
    }
