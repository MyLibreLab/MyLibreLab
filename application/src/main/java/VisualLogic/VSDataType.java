...
import VisualLogic.variables.VSObjRef;
...
public class VSDataType {
    ...
    private static final BasicStroke dashed1D =
    ...
    private static final BasicStroke dashed2D =
            new BasicStroke(3.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 1.0f, dash2, 1.0f);
    private static final BasicStroke dashedGrp =
    ...
    public static VSObject createPinDataType(int dataType) {
        switch (dataType) {
            case ExternalIF.C_GROUP:
                return new VSGroup();
            case ExternalIF.C_BOOLEAN:
                return new VSBoolean();
            case ExternalIF.C_INTEGER:
                return new VSInteger();
            case ExternalIF.C_DOUBLE:
                return new VSDouble();
            case ExternalIF.C_STRING:
                return new VSString();
            case ExternalIF.C_BYTE:
                return new VSByte();
            case ExternalIF.C_COLOR:
                return new VSColor(Color.BLACK);
            case ExternalIF.C_ARRAY1D_BOOLEAN:
                return new VS1DBoolean(1);
            case ExternalIF.C_ARRAY1D_INTEGER:
                return new VS1DInteger(1);
            case ExternalIF.C_ARRAY1D_DOUBLE:
                return new VS1DDouble(1);
            case ExternalIF.C_ARRAY1D_STRING:
                return new VS1DString(1);
            case ExternalIF.C_ARRAY2D_BYTE:
                return new VS2DByte(1, 1);
            case ExternalIF.C_ARRAY2D_BOOLEAN:
                return new VS2DBoolean(1, 1);
            case ExternalIF.C_ARRAY2D_INTEGER:
                return new VS2DInteger(1, 1);
            case ExternalIF.C_ARRAY2D_DOUBLE:
                return new VS2DDouble(1, 1);
            case ExternalIF.C_ARRAY2D_STRING:
                return new VS2DString(1, 1);
            case ExternalIF.C_IMAGE:
                return new VSImage24(1, 1);
            case ExternalIF.C_ARRAY1D_BYTE:
                return new VS1DByte(1);
            case ExternalIF.C_CANVAS:
                return new VSCanvas();
            case ExternalIF.C_FONT:
                return new VSFont(new Font("Arial", Font.PLAIN, 10));
            case ExternalIF.C_FLOWINFO:
                return new VSFlowInfo();
            case ExternalIF.C_OBJECT:
                return new VSObjRef();
    ...
    public static String getPinDataTypeWithDefaultType(int dataType) {
        switch (dataType) {
            ...
            case ExternalIF.C_BYTE:
                return "VSByte()";
            case ExternalIF.C_COLOR:
                return "VSColor(Color.BLACK)";
            case ExternalIF.C_ARRAY1D_BOOLEAN:
                return "VS1DBoolean(1)";
            case ExternalIF.C_ARRAY1D_INTEGER:
                return "VS1DInteger(1)";
            case ExternalIF.C_ARRAY1D_DOUBLE:
                return "VS1DDouble(1)";
            case ExternalIF.C_ARRAY1D_STRING:
                return "VS1DString(1)";
            case ExternalIF.C_ARRAY2D_BYTE:
                return "VS2DByte(1,1)";
            case ExternalIF.C_ARRAY2D_BOOLEAN:
                return "VS2DBoolean(1,1)";
            case ExternalIF.C_ARRAY2D_INTEGER:
                return "VS2DInteger(1,1)";
            case ExternalIF.C_ARRAY2D_DOUBLE:
                return "VS2DDouble(1,1)";
            case ExternalIF.C_ARRAY2D_STRING:
                return "VS2DString(1,1)";
            case ExternalIF.C_IMAGE:
                return "VSImage24(1,1)";
            case ExternalIF.C_ARRAY1D_BYTE:
                return "VS1DByte(1)";
            case ExternalIF.C_CANVAS:
                return "VSCanvas()";
            case ExternalIF.C_FONT:
                return "VSFont(new Font(\"Arial\",Font.PLAIN,10))";
            case ExternalIF.C_FLOWINFO:
                return "VSFlowInfo()";
            case ExternalIF.C_OBJECT:
                return "VSObjRef()";
    ...
    public static void setColorStrokeFromDataType(java.awt.Graphics2D g, int dataType) {
        ...
        switch (dataType) {
            ...
            case ExternalIF.C_COLOR:
                color = new Color(12, 117, 109);
                lineStyle = standard;
                break;
            case ExternalIF.C_IMAGE:
                color = new Color(252, 58, 131);
                lineStyle = standard;
                break;
            case ExternalIF.C_CANVAS:
                color = new Color(52, 158, 31);
                lineStyle = dashed1D;
                break;
            case ExternalIF.C_FONT:
