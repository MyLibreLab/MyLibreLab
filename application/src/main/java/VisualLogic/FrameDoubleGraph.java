...
public class FrameDoubleGraph extends javax.swing.JFrame {
    ...
    private final DefaultListModel<ColoredListCell> model = new DefaultListModel<>();
    ...
    /*
     * private void verarbeiteListe(ArrayList<VSObject> list) { double[] xValues;
     * double[] yValues;
     ...
     *
     * VSObject o; VSDouble n; for (int i=0;i<yValues.length;i++) { o=list.get(i);
     * n=(VSDouble)o;
     ...
     *
     * for (int i=0;i<basis.dataHistory.size();i++) { entry =
     * basis.dataHistory.getEntry(i);
     *
     * if (entry.values.size()>0) { obj=entry.values.get(0); if (obj instanceof
     * VSDouble) {
