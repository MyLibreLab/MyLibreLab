...
public class DialogSaveAsModul extends javax.swing.JDialog implements ElementPaletteIF {
    ...
    public void executeEditDirectory(String directory) {
        ...
        String n = directory.substring(index + 1);
    ...
    private void createDocDirsIfNotExist(String baseDir) {
        ...
        if (!doc_es.exists()) {
            ...
            try (PrintWriter out = new PrintWriter(baseDir + "/doc_es/index.html")) {
                String html_es = html;
                html_es = html_es.replaceAll("#title#", "Aqu� su T�tulo");
    ...
    private void initComponents() {
        ...
        jButton6.setText(bundle1.getString("�ffne das Deutsch Dokumentations-Verzeichnis")); // NOI18N
        ...
        jButton7.setText(bundle1.getString("�ffne das Englische Dokumentations-Verzeichnis")); // NOI18N
        ...
        jButton8.setText(bundle1.getString("�ffne das Spanische Dokumentations-Verzeichnis")); // NOI18N
        ...
        jLabel8.setText("�ffne das Dokumentations-Verzeichnis um mit Deinen HTML Editor die index.html zu bearbeiten");
