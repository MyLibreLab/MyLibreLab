...
public class Draht implements Serializable {
    ...
    private final Stroke strockeStandard = new BasicStroke(1);
    private final Stroke strockeDick = new BasicStroke(3);
    private final Stroke strockeExtraDick = new BasicStroke(4);

    private boolean selected = false;
    private final double aktuellesValue = 0.0;
    private int id = -1;
