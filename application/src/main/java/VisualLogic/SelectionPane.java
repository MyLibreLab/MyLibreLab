...
public class SelectionPane extends JPanel implements MouseListener, MouseMotionListener, KeyListener {
    ...
    private final Color colorSelected = new Color(255, 0, 0, 110);
    private final Color colorInavtive = new Color(150, 150, 150, 0);
    ...
    private final Stroke standardStroke = new BasicStroke(strokeWidth);
