...
public class FrameBooleanGraph extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        myGraph1.setMaxY(100.0);
        myGraph1.setMinX(-10.0);
        myGraph1.setMinY(-10.0);
    ...
    private void sdfsd() {
        /*
         * basis.dataHistory.getEntry() LinkedList<DataEntry>
         * list=basis.dataHistory.list;
         *
         * DataEntry obj; for (int i=0;i<list.size();i++) { obj=list.get(i); if
         * (obj.value instanceof
