...
public class DialogDistributionAssistent extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle =
                java.util.ResourceBundle.getBundle("VisualLogic/DialogDistributionAssistent_es_ES"); // NOI18N
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(layout.createSequentialGroup().addGroup(layout
                                                        ...
                                                        .addComponent(jLabel3, javax.swing.GroupLayout.DEFAULT_SIZE, 87,
                                                                Short.MAX_VALUE))
                                                        .addPreferredGap(
                                                                javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                                .addComponent(jLabel5, javax.swing.GroupLayout.DEFAULT_SIZE, 105,
                                                        Short.MAX_VALUE)
                                                .addComponent(
                                                        jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, 105,
                                                        Short.MAX_VALUE))
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                        layout.createSequentialGroup().addGroup(layout
                                                                ...
                                                                .addGap(13, 13, 13))
                                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                        layout.createSequentialGroup().addComponent(jTextField2)
                                                                .addContainerGap())
                                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
    ...
    {// GEN-HEADEREND:event_jButton5ActionPerformed
        ...
        chooser.setDialogTitle(java.util.ResourceBundle.getBundle("VisualLogic/DialogDistributionAssistent_es_ES")
                .getString("BROWSE..."));
    ...
    {// GEN-HEADEREND:event_jButton4ActionPerformed
        ...
        if (jComboBox1.getSelectedItem() == null || ((String) jComboBox1.getSelectedItem()).length() == 0) {
            Tools.showMessage(this, java.util.ResourceBundle.getBundle("VisualLogic/DialogDistributionAssistent_es_ES")
                    .getString("PLEASE SELECT A MAIN VM."));
            return;
        }
