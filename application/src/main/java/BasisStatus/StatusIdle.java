...
public class StatusIdle implements StatusBasisIF {
    ...
    private final JMenu mnuReihenfolge;
    ...
    private final JPopupMenu popDraht = new JPopupMenu();
        ...
        if (aktuellesElement != null) {
            ...
            if (vmObject == vmObject.owner.getFrontBasis()) {
                if (aktuellesElement.circuitElement != null) {
                    ...
                    aktuellesElement.circuitElement.processPropertyEditor();
                }
                ...
                aktuellesElement.panelElement.processPropertyEditor();
            }
        }
    }
