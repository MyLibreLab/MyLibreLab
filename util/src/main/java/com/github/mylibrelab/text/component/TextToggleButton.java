...
/**
 * Toggle button which takes {@link Text} instead of a {@link String}.
 */
public class TextToggleButton extends JToggleButton {
    ...
    /**
     * Create a new {@link TextToggleButton}.
     *
     * @param text the text of the toggle button.
     */
    public TextToggleButton(@NotNull final Text text) {
        this(text, null);
    }
     ...
     *
     * @param text the text of the toggle button.
     * @param icon the icon of the toggle button.
     */
    public TextToggleButton(@NotNull final Text text, @Nullable final Icon icon) {
