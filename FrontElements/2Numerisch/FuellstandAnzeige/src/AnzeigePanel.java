...
public class AnzeigePanel extends JVSMain implements PanelIF
{
  ...
  private VSColor EdgeColor = new VSColor(new Color(253,143,0));
  ...
  private void localize()
  {
    ...
    element.jSetPEItemLocale(d+12,language,"Init Value");
    element.jSetPEItemLocale(d+13,language,"Round Rect En");
    ...
    element.jSetPEItemLocale(d+12,language,"Valor Inicial");
    element.jSetPEItemLocale(d+13,language,"Redondear Forma");
