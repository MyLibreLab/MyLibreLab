  ...
  public void processPanel(int pinIndex, double value, Object obj)
  {
   ...
   public void paint(java.awt.Graphics g)
   {
      if (element!=null)
      {
         ...
         g2.drawRoundRect(X0+(TempStroke/2), Y0+(TempStroke/2), tWidth-TempStroke, tHeight-TempStroke,20,20);
         
         g2.setStroke(strokeLine);
          
         g2.setColor(edgeColor.getValue());
         g2.drawRoundRect(X0, Y0, tWidth, tHeight,40,40);
         //g2.drawRoundRect(X0+(TempStroke/8), Y0+(TempStroke/8), tWidth-(TempStroke/4), tHeight-(TempStroke/4),20,20);
