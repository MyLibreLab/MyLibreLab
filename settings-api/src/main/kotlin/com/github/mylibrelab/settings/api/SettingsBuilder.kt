...
import com.github.mylibrelab.util.assertNonNull
import com.github.mylibrelab.util.castSafelyTo
import com.github.mylibrelab.util.map
...
/**
 * Convenience class for SettingsContainerProvider which simply serve a singleton value.
 */
